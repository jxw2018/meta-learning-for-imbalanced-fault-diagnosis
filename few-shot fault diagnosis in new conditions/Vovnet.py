...
from pre_train_vovnet import pre_train
...
def main():
    ...
    sheet = book.add_sheet('vovnet',cell_overwrite_ok=True)   
    for i in range(4):
        for j in range(4):
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--pre_epoch', type=int, help='pre train epoch number', default=10)
