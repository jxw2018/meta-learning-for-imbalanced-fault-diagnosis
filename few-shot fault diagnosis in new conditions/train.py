...
#    pre_model(pre_data)
    ...
    for epoch in range(1, args.epoch+1):
        ...
        for step, (x_spt, y_spt, x_qry, y_qry) in enumerate(db):
            ...
            accss = maml.train(x_spt, y_spt, x_qry, y_qry)

        if epoch % 1 == 0:
            print('epoch:', epoch, 'training acc:', accs[-1], 'train_acc:', accss, 'loss:', losses_q[-1])
        ...
        if epoch % 1 == 0:  # evaluation
            ...
            for x_spt, y_spt, x_qry, y_qry in db_test:
                ...
                accss, test_confusion, f_score, g_mean = maml.test(x_spt, y_spt, x_qry, y_qry)

            print('Test acc:', accs[-1], 'train_test_acc:', accss)
        if accs[-1] >= 0.86:
            break
    ...
    for i in range(10):
        ...
        for x_spt, y_spt, x_qry, y_qry in db_test:
            ...
            accs, test_confusion, f_score, g_mean = maml.test(x_spt, y_spt, x_qry, y_qry)
